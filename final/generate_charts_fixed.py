...
ax.plot(xfit, yfit, color=colors["gray900"], linewidth=2.0, zorder=3,
...
markers = {"Ethiopia":(18, -26), "India":(18, 14), "China":(18, 14),
           "United States":(-18, -28), "Japan":(-18, 12)}
...
ax.legend(loc="lower right", bbox_to_anchor=(0.995, 0.06), fontsize=10, framealpha=0.95, frameon=True)
ax.spines["top"].set_visible(False)
ax.spines["right"].set_visible(False)
